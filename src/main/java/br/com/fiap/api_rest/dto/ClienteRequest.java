...
public class ClienteRequest {
    ...
    @Size(min = 3, max = 150, message = "O nome deve ter entre 3 e 150 caractéres")
    private String nome;
    ...
    @Pattern(regexp = "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)(?=.*[@!#])[A-Za-z\\d@!#]{8,}$",
            message = "A senha deve conter pelo menos uma letra maiúscula, uma letra minúscula, um número e um " +
                    "caractere especial (@, !, #)")
